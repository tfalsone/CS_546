...
// 206
console.log(lab1.questionOne([3, 5, 7]));
// 83
...
console.log("-------------- Q3 --------------");
console.log(lab1.questionThree("Mr. and Mrs. Dursley, of number four, Privet Drive, "
    + "were  proud  to  say  that  they  were  perfectly  normal,  thank you  very  much."
    + " They  were  the  last  people  youd  expect  to  be  involved in anything strange "
    + "or mysterious, because they just didn't hold with such nonsense. \n Mr. Dursley was "
    + "the director of a firm called Grunnings, which  made  drills.  He  was  a  big,  beefy  "
    + "man  with  hardly  any  neck,  although he did have a very large mustache. Mrs. Dursley "
